...
class HungarianMatcher(nn.Module):
    ...
    @torch.no_grad()
    def memory_efficient_forward(self, pred_logits, pred_masks, gt_classes, gt_masks):
        ...
        for b in range(bs):
            ...
            out_mask = pred_masks[b]  # [num_queries, H_pred, W_pred]
    ...
    def forward(self, pred_logits, pred_masks, gt_classes, gt_masks):
        ...
        """
        return self.memory_efficient_forward(pred_logits, pred_masks, gt_classes, gt_masks)
